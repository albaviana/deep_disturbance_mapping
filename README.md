...
We implemented two temporal architectures for pixel-wise forest disturbance detection: a TempCNN adapted from Pelletier et al. (2019) and Perbet et al. (2024) and a 1D U-Net, adapted from Ronneberger et al. (2015). [Disturbance mapping]([https://github.com/jorunnmense/forest-disturbance-detection-landsat-europe])
